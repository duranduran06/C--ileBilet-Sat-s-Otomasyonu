...
namespace Otobüs
{
    public partial class Form1 : Form
    {
        ...
        {
            //SEÇİLEN OTOBÜS TÜRÜNE GÖRE KAÇ SIRA KOLTUK OLACAĞI
            #region
        ...
        {
            //HER SEFERİNDE KOLTUKLAR YENİLENİRKEN YERLERİNİN KAYMAMASI İÇİN SİLME İŞLEMİ
        #region

        git:
            foreach (Control bak in this.Controls)//form başlayınca kontrollerı getır 
            { 

                if (bak is Button)//ama sadece buttonların kontolu lazım
                {
                ...
                if (bak is Label)// sadece label lar
                {
                    Label lbl = bak as Label;
                    if (lbl.Text != "KAPI") //texti kapı olmayanları atla
                        continue;
                    else
            ...
            #endregion
            //OTOBÜS KOLTUKLARININ OLUŞTURULMASI,ARKA BEŞLİMİ KONTROLÜ,MAUSE İLE TIKLANMAYI ALGILAMA İŞLEMLERİ
        #region
            int koltukno = 1;
                ...
                for (int j = 0; j < 5; j++)
                {
                   ...
                   if(sıra<10)
                   ...
                   else
                    {
                        ...
                        oluştur.Text = koltukno.ToString();
                        oluştur.ContextMenuStrip = contextMenuStrip1;
                        oluştur.MouseDown += koltuk_mausedown;//sağ tık algılama
                        koltukno++;
                        this.Controls.Add(oluştur);
        ...
        public Button tıklama;//koltuk numarası tıklama.text de
        ...
        {
            Random rnd = new Random();
            int bir = rnd.Next(0, 255);
            int iki = rnd.Next(0, 255);
            int üç = rnd.Next(0, 255);
            label1.ForeColor = Color.FromArgb(bir, iki, üç);
        ...
        {
            //ZORUNLU ALANLARIN DOLDURULUP VE BİLET YERİ BOŞMU KONTROLÜ YAPIP BİLET OLUŞTURMA
            #region
        ...
        private void verikaydet()
        {
            ...
            try
            {
                ...
                //YAZICI CIKTISI EKLEME YAPABİLRLİM BAK
        ...
        {
            //KOLTUK SEÇİM ALAN ÇERÇEVESİ OLUŞTURMA
            #region
